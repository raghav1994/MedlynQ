// Doc-level + case-level synopsis types and mock data. Currently mock-only —
// the older pipeline.py that was meant to produce real data for this was
// never actually wired in and has since been removed as dead code.
