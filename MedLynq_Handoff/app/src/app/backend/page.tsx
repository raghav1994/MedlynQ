...
// "SHA" and "Railway" here previously weren't valid Scheme values at all
// (the real ones are "Ayushman" and "Railway_UMID") — silently never
// matched anything in schemeEmpanelled below.
const EMPANELLED_SCHEMES: Scheme[] = ["PMJAY", "Ayushman", "CGHS", "Railway_UMID", "ECHS", "ESI"];
